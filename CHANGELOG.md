...
# [1.4.0](https://github.com/flyimg/flyimg/compare/1.3.4...1.4.0) (2024-09-12)


### Bug Fixes

* 483 ([dba38b2](https://github.com/flyimg/flyimg/commit/dba38b24729009ac64c7f4963b48e48a68a88606))
* 483 ([924c4c1](https://github.com/flyimg/flyimg/commit/924c4c103dc73e6c2e8649fb60eb5aa63eef8cab))
* add cleanup cron job to purge tmp folder ([e576189](https://github.com/flyimg/flyimg/commit/e57618949e175e42831436fb1bea67fd61c09937))
* add cleanup cronjob documentation ([ad52de1](https://github.com/flyimg/flyimg/commit/ad52de14915511d01305c874507d7ae6872aa219))
* add Cleanup cronjob to purge var/tmp folder ([d1d4362](https://github.com/flyimg/flyimg/commit/d1d436202cbab99f2611de52da67ca0db37b36b8))
* add css style to version element ([adab8bb](https://github.com/flyimg/flyimg/commit/adab8bb7d23c65b5a83b467c11ef8cc85c5d84e3))
* add current version to the home page ([37a801d](https://github.com/flyimg/flyimg/commit/37a801dbdd3e7adc7600ebb63215d272884300ac))
* add missing ambimax/semantic-release-composer library ([d8e6530](https://github.com/flyimg/flyimg/commit/d8e65303afe3715f5155f707d32f051259b1c3a0))
* add options_separator to js code ([f92ce57](https://github.com/flyimg/flyimg/commit/f92ce570d777e4035676d3bd3705f67fe757d220))
* add requirements.txt for the python scripts ([3fec3f6](https://github.com/flyimg/flyimg/commit/3fec3f6b8c10f8fa9437d585959db3e945d18910))
* Fix cronjob to cleanup the tmp folder and JetBrains log, closes [#502](https://github.com/flyimg/flyimg/issues/502) ([238dd73](https://github.com/flyimg/flyimg/commit/238dd7367b8138e41de80bc83039d4d549002826))
* fix default sperator in js code ([124bbe4](https://github.com/flyimg/flyimg/commit/124bbe4efe7806c30e2b69691122fa28ac37040f))
* fix linting errors ([24400cf](https://github.com/flyimg/flyimg/commit/24400cf64aabee567720463a4628061de7dd9225))
* fix smart crop feature, use new base image version ([2d7d750](https://github.com/flyimg/flyimg/commit/2d7d750aac2b6561aca75454ea6ec99e7a02f125))
* fixing linting issues ([afd0f5c](https://github.com/flyimg/flyimg/commit/afd0f5c0ce991f57ab36d90afcdc3bf0d5778fb0))
* fixing linting issues ([22e1884](https://github.com/flyimg/flyimg/commit/22e1884f5f49c48c5050f25d4763d918e2ebfa73))
* fixing python linting error ([d30cb75](https://github.com/flyimg/flyimg/commit/d30cb752aaef3fb3d6c077cba001caa35d1a36fe))
* fixing S3 not working, upgrading league/flysystem lib, closes[#493](https://github.com/flyimg/flyimg/issues/493) ([92297ce](https://github.com/flyimg/flyimg/commit/92297ce85287e165f26835263fe1b8343eaec2f4))
* fixing the @iwavesmedia/semantic-release-composer lib ([d0be7ff](https://github.com/flyimg/flyimg/commit/d0be7ff75e7eaa363e7c81c383ec86e68085c768))
* Redirect URLs without protocol schema are not handled correctly, closes [#486](https://github.com/flyimg/flyimg/issues/486) ([83953b2](https://github.com/flyimg/flyimg/commit/83953b25b5add62dbe2124dde726ed73da8ec4dc))
* Rename the build image to flyimg/flyimg, run composer update, remove linux/arm/v6 from target platform ([7352115](https://github.com/flyimg/flyimg/commit/73521151d1a7cdbf8e47c8d66436535cae7bc945))
* update flyimg base version to support multi arch build, fixing [#414](https://github.com/flyimg/flyimg/issues/414) ([bce45de](https://github.com/flyimg/flyimg/commit/bce45debbb99e85809d6d66b53155480c61b620c))
* use latest base image that include cron service ([a8acc06](https://github.com/flyimg/flyimg/commit/a8acc06d768dc42814864c114355761118634616))
* use new base image version (php 8.3 + updated libraries versions) ([5a48b1d](https://github.com/flyimg/flyimg/commit/5a48b1d729ff9da24666d2155b769c1e81be55bf))


### Features

* Update README ([7ecb420](https://github.com/flyimg/flyimg/commit/7ecb4209a3e6a755b3b7aa63889b753c08f68968))
