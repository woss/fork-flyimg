<div class="exception-summary <?= !$exceptionMessage ? 'exception-without-message' : ''; ?>">
        ...
        <div class="container">
            <h2 class="exception-hierarchy">
                <?php foreach (array_reverse($exception->getAllPrevious(), true) as $index => $previousException) { ?>
                    ...
                    <span class="icon"><?= $this->include('Errors/assets/images/chevron-right.svg'); ?></span>
                <?php } ?>
    ...
    <div class="exception-message-wrapper">
        <div class="container">
            <h1 id="exception-message" class="break-long-words exception-message<?= mb_strlen($exceptionMessage) > 180 ? ' long' : ''; ?>">
    ...
    <div class="sf-tabs">
        ...
        <div class="tab <?= !$logger->getLogs() ? 'disabled' : ''; ?>">
            ...
            <div class="tab-content">
                <?php if ($logger->getLogs()) { ?>
                    <?= $this->include('Errors/logs.html.php', ['logs' => $logger->getLogs()]); ?>
                <?php } else { ?>
                    <div class="empty">
                        <p>No log messages</p>
                    </div>
        ...
        <div class="tab">
            ...
            <div class="tab-content">
                <?php
                foreach ($exceptionAsArray as $i => $e) {
                    echo $this->include('Errors/traces_text.html.php', [
                        'exception' => $e,
                        'index' => $i + 1,
