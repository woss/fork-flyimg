    ...
    <div class="trace-details">
        <div class="trace-head">
            <div class="sf-toggle" data-toggle-selector="#trace-html-<?= $index; ?>" data-toggle-initial="<?= $expand ? 'display' : ''; ?>">
                <span class="icon icon-close"><?= $this->include('Errors/assets/images/icon-minus-square-o.svg'); ?></span>
                <span class="icon icon-open"><?= $this->include('Errors/assets/images/icon-plus-square-o.svg'); ?></span>
                <?php
        ...
        foreach ($exception['trace'] as $i => $trace) {
            ...
            <div class="trace-line <?= $isVendorTrace ? 'trace-from-vendor' : ''; ?>">
                <?= $this->include('Errors/trace.html.php', [
                    'prefix' => $index,
                    'i' => $i,
                    'trace' => $trace,
